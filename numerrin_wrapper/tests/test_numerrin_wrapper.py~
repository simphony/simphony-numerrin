...
from simphony.wrappers.numerrin_wrapper.numerrin_wrapper import NumerrinPool, NumerrinCode, NumerrinWrapper
...
class NumerrinWrapperTestCase(unittest.TestCase):
    ...
    def test_meshRead(self):
        ...
        numerrin_wrapper.setProgramFile("mesh_extrusion.num")
